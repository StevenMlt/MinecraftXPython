# Créé par Steven, le 07/03/2021 en Python 3.7
...
def explication_Blocks_MiniJeux(): #Fonction pour envoyer un message d'explication quand le Joueur se trouve dans 1 des 4 zones de départ.
    ...
    if pos.x<=X1_2 and pos.x>=X1_1 and pos.y<=Y1_2 and pos.y>=Y1_1 and pos.z<=Z1_2 and pos.z>=Z1_1 and message_Ecrit1==False:
        #Si joueur dans zone Violette et que le message n'a pas été écrit(anti-spam)
